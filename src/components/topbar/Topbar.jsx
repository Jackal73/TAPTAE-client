  ...
  return (
    <div className="h-[75px] w-full flex items-center justify-center sticky top-0 z-[999] bg-[#e0e6f6] rounded-2xl shadow-md backdrop-blur-[15px] border border-solid border-[#0000004d]">
      ...
      <div className="navigation ml-[64px]" ref={menuRef} onClick={toggleMenu}>
        ...
        <div className="absolute right-6 top-6 font-semibold hover:shadow">
          <Link
            to="/login"
            style={{ textDecoration: "none" }}
            className=" !text-black/80 hover:!text-[blue]"
          >
            admin portal
          </Link>
        </div>
...
//   return (
//     <div className="flex h-[75px] w-full items-center justify-center fixed top-0 z-[999] bg-[#e0e6f6] rounded-2xl shadow-md backdrop-blur-[15px] border border-solid border-[#0000004d]">
//       <div className="absolute left-0">
//         <div className="w-[70px] ml-[12px]">
//           <img
